...
<body>
	...
	<section class="hero-section set-bg" data-setbg="img/bg.jpg">
		<div class="container hero-text text-white">
			...
			<p>Search real estate property records, houses, condos, land and more on realHome.com®.<br>Find property info from the most comprehensive source data.</p>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="propertie-item set-bg" data-setbg="img/propertie/1.jpg">
						...
						<div class="propertie-info text-white">
							<div class="info-warp">
								<h5>176 Ihunda street, Rumuekini</h5>
								<p><i class="fa fa-map-marker"></i> Portharcourt, Rivers state</p>
							</div>
				...
				<div class="col-md-6">
					<div class="propertie-item set-bg" data-setbg="img/propertie/2.jpg">
						...
						<div class="propertie-info text-white">
							<div class="info-warp">
								<h5>45 Chibuike Amaechi Drive, Ikwerre street</h5>
								<p><i class="fa fa-map-marker"></i> Portharcourt, Rivers State</p>
							</div>
							<div class="price">&#x20A6;60,500/month</div>
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="propertie-item set-bg" data-setbg="img/propertie/3.jpg">
						...
						<div class="propertie-info text-white">
							<div class="info-warp">
								<h5>Km 20, Peter Odili drive</h5>
								<p><i class="fa fa-map-marker"></i> G.R.A, Rivers State</p>
							</div>
							<div class="price">&#x20A6;52,500,000</div>
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="propertie-item set-bg" data-setbg="img/propertie/4.jpg">
						...
						<div class="propertie-info text-white">
							...
							<div class="price">&#x20A6;37,500/month</div>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="services">
						<div class="service-item">
							...
							<div class="service-text">
								...
								<p>Expertise advice and help in securing your dream home, as well as offer solid management ideas</p>
							</div>
						</div>
						<div class="service-item">
							...
							<div class="service-text">
								...
								<p>We manage properties in the best ways possible, delivering cutting edge Management skills with excellence</p>
							</div>
						</div>
						<div class="service-item">
							...
							<div class="service-text">
								...
								<p>Whether you wish to Rent your Properties or Sell it, we help link buyers to genuine sellers as much as link prospective clients/tenants to LandLords</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6">
					...
					<div class="feature-item">
						...
						<div class="feature-text">
							...
							<a href="#" class="room-price">&#x20A6;55,200,000</a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					...
					<div class="feature-item">
						...
						<div class="feature-text">
							...
							<a href="#" class="room-price">&#x20A6;90,000,000</a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					...
					<div class="feature-item">
						...
						<div class="feature-text">
							...
							<a href="#" class="room-price">&#x20A6;29,500/month</a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					...
					<div class="feature-item">
						...
						<div class="feature-text">
							...
							<a href="#" class="room-price">&#x20A6;50,600,000</a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					...
					<div class="feature-item">
						...
						<div class="feature-text">
							...
							<a href="#" class="room-price">&#x20A6;45,000/month</a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					...
					<div class="feature-item">
						...
						<div class="feature-text">
							...
							<a href="#" class="room-price">&#x20A6;75,600,000</a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="review-slider owl-carousel">
				<div class="review-item text-white">
					...
					<p>“realHome was quick to understand my needs and steer me in the right direction. Their professionalism and warmth made the process of finding a suitable home a lot less stressful than it could have been. Thanks, agent Tony Holland.”</p>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 blog-item">
					...
					<h5><a href="single-blog.html">Taylor Swift is selling her &#x20A6;300million Beverly Hills mansion</a></h5>
					<div class="blog-meta">
						<span><i class="fa fa-user"></i>Amanda Seyfried</span>
						<span><i class="fa fa-clock-o"></i>25 Jun 2019</span>
					</div>
					<p>Integer luctus diam ac scerisque consectetur. Vimus dotnetact euismod lacus sit amet. Aenean interdus mid vitae maximus...</p>
				</div>
				<div class="col-lg-4 col-md-6 blog-item">
					<img src="img/blog/3.jpg" alt="">
					<h5><a href="single-blog.html">LASGIDI luxury housing market saturated with inventory, says celebrity realtor</a></h5>
					<div class="blog-meta">
						<span><i class="fa fa-user"></i>Amanda Seyfried</span>
						<span><i class="fa fa-clock-o"></i>25 Jun 201</span>
					</div>
